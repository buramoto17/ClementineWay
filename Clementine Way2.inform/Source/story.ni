...
Recipe storage is a closed openable container in the kitchen. It is undescribed. The description is "It is a white wood storage container that I keep my recipes in. I call it my recipe storage.[if Recipe storage is closed] It is closed.[end if][if Recipe storage is open]It is open. There are a lot of recipies in here, but nothing of interest at the moment.[end if][If Story Line is 2] There are a bunch of interesting recipes in here, but there is one that you had intended to make for Jennifer. Ole Casserole Recipe.[end if]"
...
An every turn rule:
	If player is in Clementine Way:
		If Story Line is less than 3:
			Say "[If Story Line is 0]Where am I going? I haven't even contacted Jennifer yet.[end if][if Story Line is 2]I haven't finished making the casserole yet![end if]";
